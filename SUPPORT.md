...
CmdZ 1.0.3 and newer leave **Command + Z** or **Ctrl + Z** untouched when an
...
1. Open `chrome://extensions` and confirm that CmdZ is version 1.0.3 or newer.
...
CmdZ 1.0.3 automatically attaches its listener to web pages that were already

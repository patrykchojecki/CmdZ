...
The `sessions` permission is the narrowest Chrome permission that can restore a recently closed tab. CmdZ does not request host permissions and cannot read page content.
